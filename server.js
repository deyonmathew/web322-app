...
cloudinary.config({
    cloud_name: process.env.CLOUD_NAME || "dq4sbqgvx",
    api_key: process.env.CLOUDINARY_API_KEY || "716443399666242",
    api_secret: process.env.CLOUDINARY_API_SECRET || "DEndDHOlU2QYhCMIHlaqJrE5J_k",
    secure: true
});
